...
$fnameErr = $lnameErr = $emailErr = $mobErr = $passErr = "";
$fname = $lname = $email = $mob = $password = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($_POST["mob"])) {
    ...
    if(!preg_match('/^[0-9]{3}-[0-9]{3}-[0-9]{4}$/', $_POST['mob'], $mob))
    {
      $mobErr = 'Please enter the correct Number';
    }  
...
$passErr = 'Passwords should be same<br>'; 
}
  }
 // function validateMemberPasswordRepeat($re-pass){
			...
			<div class="carousel slide" id="carousel-64613">
				...
				<div class="col-md-8">
					<div class="page-header"><div style="float:left">
						<h1>
							Create an Account  <small style="color: #8f9699">It's free and always will be....!</small>
						</h1></div>
					</div>
				</div>
<div class="row" >
		<div class="col-md-12" style="background-color: #527294"><br><br><br><br><br><br>
			<form class="form-horizontal" role="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="inputtext" autofocus name="fname" placeholder="First name" >
						 <span class="error"  style="color:#8f9699">* <?php echo $fnameErr;?></span>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="inputtext" name="lname" placeholder="Last name" >
						<span class="error"  style="color:#8f9699">* <?php echo $lnameErr;?></span>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="email" class="form-control" id="inputEmail3" name="email" placeholder="Email Id">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="inputtext" name="mob" placeholder="We will send booking details ">
						<span class="error"  style="color:#8f9699">* <?php echo $mobErr;?></span>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-5">
						...
						<span class="error"  style="color:#8f9699">* <?php echo $passErr;?></span>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="password" class="form-control" id="inputPassword3" name="re-password" placeholder="Re-enter Password">
					</div>
				</div>
				<div class="form-group">
					<!--<div class="col-sm-offset-2 col-sm-10">
						<div class="hyperlink">
							...
							<label>
								<a href="forgot.html" style="color:#8f9699"> Forgot Your Password?</a> | <a href="sign.html" style="color:#8f9699"> Create a new account.</a>
							</label>
						</div>
					</div>-->
					<div class="col-sm-offset-2 col-sm-10">
				...
				<div class="form-group">
					...
					<div class="col-sm-offset-2 col-sm-10">
						<div class="hyperlink">
							...
							<label><br>
								<a href="login.php" style="color:#8f9699"> Login here</a> | <a href="home.html" style="color:#8f9699"> Go back to Home</a>
							</label>
						</div>
					</div>
				</div>
