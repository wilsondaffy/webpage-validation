			...
			<div class="carousel slide" id="carousel-64613">
				...
				<div class="col-md-8">
					<div class="page-header"><div style="float:left">
						<h1>
							Login  <small style="color: #8f9699">Get more details about Us...!</small>
						</h1></div>
					</div>
				</div>
<div class="row" >
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<div class="hyperlink">
							...
							<label>
								<a href="forgot.php" style="color:#8f9699"> Forgot Your Password?</a> | <a href="sign.php" style="color:#8f9699"> Create a new account.</a>
							</label>
						</div>
					</div>
					<div class="col-sm-offset-2 col-sm-10">
